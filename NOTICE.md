...
This repository is a clean publication snapshot of a Vontar H618 bring-up
payload extracted from a local Armbian build workspace.

## Scope

- Board-specific configuration, patch files, diagnostics scripts, and
  documentation needed to reproduce the public workflow are included.
- Build caches, generated images, logs, local recovery helpers, and other
